...
function textureRotate(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    // create a texture from an image path
    let texture;

    app.loader.add("flowerTop", "~/assets/images/flowerTop.png");
...
function multiPassShaderGenMesh(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    app.view.height = 640;
    // Build geometry.
...
export function meshSharingGeo(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    const geometry = new PIXI.Geometry()
        .addAttribute(
            "aVertexPosition", // the attribute name
...
`
    ...
    const triangle2 = new PIXI.Mesh(
        geometry,
        new (PIXI as any).Shader(program, {
            uSamplerTexture: PIXI.Texture.from("~/assets/images/bg_rotate.jpg"),
        })
    );
    ...
    const triangle3 = new PIXI.Mesh(
        ...
        new (PIXI as any).Shader(program, {
            uSamplerTexture: PIXI.Texture.from(
                "~/assets/images/bg_displacement.jpg"
            ),
        })
    );
...
export function meshShader(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    ...
    const uniforms = {
        uSampler2: PIXI.Texture.from("~/assets/images/bg_scene_rotate.jpg"),
        time: 0,
    };
...
export function renderTextureAdvance(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    // create two render textures... these dynamic textures will be used to draw the scene into itself

    let renderTexture = (PIXI as any).RenderTexture.create(
        app.screen.width,
        app.screen.height
    );
    let renderTexture2 = (PIXI as any).RenderTexture.create(
        app.screen.width,
        app.screen.height
    );
...
export function meshBasic(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    let count = 0;
    ...
    const strip = new PIXI.SimpleRope(
        PIXI.Texture.from("~/assets/images/snake.png"),
        points
    );
...
export function meshAdvance(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    let count = 0;
...
export function dynamicGraphics(canvas) {
...
export function bitmapFont(canvas) {
...
export function explosion(canvas) {
    const app = new TNSPIXIApplication({ canvas, backgroundColor: 0x1099bb });
...
export function starWarp(canvas) {
    ...
    const starAmount = isIOS ? 1000: 100;
    let cameraZ = 0;
    const fov = 20;
...
export function container(canvas) {
    const app = new TNSPIXIApplication({ canvas, backgroundColor: 0x1099bb });
...
export function transparent(canvas) {
    const app = new TNSPIXIApplication({ canvas });

    // create a new Sprite from an image path.
    const bunny = PIXI.Sprite.from("~/assets/images/bunny.png");
...
export function eggHead(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    ...
    for (let i = 0; i < totalDudes; i++) {
        ...
        const dude: any = PIXI.Sprite.from("~/assets/images/eggHead.png");
...
export function cacheAsBitmap(canvas) {
    const app = new TNSPIXIApplication({ canvas });
...
export function particleContainer(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    ...
    for (let i = 0; i < totalSprites; i++) {
        // create a new Sprite
        const dude = PIXI.Sprite.from("~/assets/images/maggot_tiny.png") as any;
...
export function blendModes(canvas) {
    const app = new TNSPIXIApplication({ canvas });
    // create a new background sprite
    const background = PIXI.Sprite.from("~/assets/images/bg_rotate.jpg");
    ...
    for (let i = 0; i < totaldudes; i++) {
        // create a new Sprite that uses the image name that we just generated as its source
        const dude = PIXI.Sprite.from("~/assets/images/flowerTop.png") as any;
...
export function simplePlane(canvas) {
...
export function animatedJet(canvas) {
    const app = new TNSPIXIApplication({
        canvas,
    });
...
export function advance(canvas) {
    const app = new TNSPIXIApplication({
        canvas,
    });
    const sprite = PIXI.Sprite.from("~/assets/images/bg_rotate.jpg") as any;
